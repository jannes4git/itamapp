...
/**
 * @template-extends QBMapper<AssetDTO>
 */
class AssetDTOMapper extends QBMapper
{
    public function __construct(IDBConnection $db)
    {
        //der 2. string ist der db name
        parent::__construct($db, 'asset', AssetDTO::class);
    }
    ...
    public function findAll(): array
    {
        /* @var $qb IQueryBuilder */
        $qb = $this->db->getQueryBuilder();
        $qb->select('a.id', 'a.inventarnummer', 'a.rechnungsdatum', 'a.seriennummer', 'r.raumName')
